...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "bayesomatic.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "bayesomatic.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'bayesomatic'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'bayesomatic':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_05a3b6a3ad5177ada977535d00ecde1ffdf454c7": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);setTimeout(()=>{document.querySelector(($0)).value=($1);},10);
            },
            ...
            "__cargo_web_snippet_2b0b92aee0d0de6a955f8e5540d7923636d951ae": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){try{return{value:function(){return($1).origin;}(),success:true};}catch(error){return{error:error,success:false};}})());
            },
            ...
            "__cargo_web_snippet_353fca2c4dd22a82290d3efa60bede5c367a0147": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var g=graphlibDot.read(($0));g.graph().marginx=20;g.graph().marginy=20;var svg=($1);setTimeout(()=>{d3.select(svg).call(render,g);var bbox=svg.getBBox();svg.setAttribute("viewBox",(bbox.x-10)+" "+(bbox.y-10)+" "+(bbox.width+20)+" "+(bbox.height+20));svg.setAttribute("width",(bbox.width+20)+"px");svg.setAttribute("height",(bbox.height+20)+"px");},10);
            },
            ...
            "__cargo_web_snippet_650d4d934d99c2edff372464e8726ca9cb8159fc": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);setTimeout(()=>{document.querySelector("textarea[name=prior_description]").value=($0);},10);
            },
            ...
            "__cargo_web_snippet_a0f70f6a370c120e24689bc82d38e50a8570fc5d": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);setTimeout(()=>{document.getElementById("nodedesc").value=($0);},10);
            },
