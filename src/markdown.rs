...
/// Taken from https://github.com/DenisKolodin/yew/blob/master/examples/crm/src/markdown.rs
/// Updated to pulldown_cmark 0.5
    ...
    COMP: Component,
{
    ...
    for ev in Parser::new_ext(src, Options::ENABLE_TABLES) {
        match ev {
            Event::Start(tag) => {
    ...
    COMP: Component,
{
    match t {
        ...
        Tag::Strikethrough => {
            let mut el = VTag::new("span");
            el.add_class("font-strikethrough");
            el
        }
